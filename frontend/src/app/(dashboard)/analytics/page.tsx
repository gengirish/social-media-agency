            ...
            {crossLoading ? (
              ...
              <dl className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="rounded-lg bg-slate-50 p-4">
                  ...
                  {benchmarks.contributing_orgs ? (
                    <p className="mt-0.5 text-xs text-slate-500">
                      across {benchmarks.contributing_orgs} organisations
                    </p>
                  ) : null}
                </div>
              </dl>
...
function BenchmarkStat({ label, value }: { label: string; value: number | null }) {
  ...
  return (
    <div className="rounded-lg bg-slate-50 p-4">
      ...
      <p className="text-lg font-semibold text-slate-900">
        {value === null ? <span className="text-slate-400">Not measured</span> : value}
      </p>
    </div>
  );
}
